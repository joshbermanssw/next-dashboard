...
- e9e7c3c: Choose amount, rail, and reference when paying a scanned QR code
...
- 57ee5f9: Size the card number in proportion to the card face
...
- 41124d5: Pay and get paid by QR code, from the dashboard's More menu
...
- 241e03b: Let a SplitPay contributor authorise spending from their own manage link
...
- 132a4bc: Open the picked account on the dashboard from the Accounts page
...
- b3c0dc4: Add an Accounts page to the sidebar, under Products
